package com.coderbyte.shared.helper;
...
//		long differenceInTime = endWorkTime.getTime() - startWorkTime.getTime();
//		double differenceInHours = (differenceInTime / (1000 * 60 * 60)) % 24;
////		double differenceInMinuts = (((differenceInTime / 1000 * 60)) % 60 ;
